...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ModuleProject/Mediator'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'YM' => 'yangming@1yd.me' }
  s.source           = { :git => 'https://github.com/ModuleProject/Mediator.git', :tag => s.version.to_s }
...
ymCategories.source_files = 'Mediator/Categories/**/*.{h,m}'
